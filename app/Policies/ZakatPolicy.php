...
class ZakatPolicy
{
    ...
    {
        return $user->can('view_any_zakat');
    }
    ...
    {
        return $user->can('delete_any_zakat');
    }
     ...
     */
    public function replicate(User $user, Zakat $zakat): bool
    {
